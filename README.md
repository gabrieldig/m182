...
| Honeypot                  | -              | [Honeypot](honeypot.md)                                 |            | Vorzeigen  | nein                 |            |
| KI Validierung            | -              | [KI Validierung](ki_validierung.md)                     |            | Vorzeigen  | ja                   |            |
|                           |                |                                                         |            |            |                      |            |
...
| Nenne mir 5 Vulnerabilities von Dockerengine 25.0.2, mit jeweils der CVE und einem kurzen Beschreib |             |                                                                    |             |
